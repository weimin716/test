...
public class DateUtils {
    ...
    public static Date localDateTimeToDate(LocalDateTime localDateTime){
        Date dateTransfer = Date.from( localDateTime.atZone( ZoneId.systemDefault()).toInstant());
        String s = formatDate(dateTransfer, DATETIME_FORMAT);
     ...
     * @description: 日期格式化
     **/
    public static Date getDateShort(Date date,String datePattern) {
    ...
    public static Date getDateShort(String dateStr,String datePattern) {
        SimpleDateFormat sdf = new SimpleDateFormat(datePattern);
        try {
    ...
    public static Map<String, String> getTimeInterval(Date date) {
        ...
        map.put(Constant.WEEKBEGIN, weekBegin);
        map.put(Constant.WEEKEND, weekEnd);
        return map;
    }
    ...
    public static Map<String, String> getLastTimeInterval() {
        ...
        String weekBegin = new StringBuilder(lastBeginDate).append(" 00:00:00").toString();
        String weekEnd = new StringBuilder(lastEndDate).append(" 23:59:59").toString();
        Map<String, String> map = new HashMap<String, String>();
        map.put(Constant.WEEKBEGIN, weekBegin);
        map.put(Constant.WEEKEND, weekEnd);
        return map;
